...
def generate_j58_map():
    ...
    return {"mach_points": machs, "altitude_points_m": alts, "values": values}
...
def run_mach4_design():
    ...
    inputs = {
        ...
        "crew": {"count": 1, "weight_per_crew_kg": 100.0, "crew_kg": 100.0},
        "propulsion": {
            "type": "jet",
            "count": 2,
        ...
        "geometry_parametric": {
            ...
            "fuselage": {"length_m": 30.0, "diameter_m": 2.0},
            "tail": {
