...
def test_systems_integration():
    inputs = {
        ...
        "payload": {"pax_count": 0, "cargo_kg": 500, "payload_kg": 500},
        "crew": {"pilot_count": 1, "attendant_count": 0, "crew_kg": 100},
        "aero": {"e": 0.8, "cl_max": 1.5, "cd0": 0.02},
        "propulsion": {"type": "prop", "engine_count": 1, "sfc_1_s": 8e-8, "prop_efficiency": 0.8},
        "sizing": {"max_iterations": 10, "wing_loading_pa": 1500.0, "aspect_ratio": 8.0, "thrust_to_weight": 0.3},
        "requirements": {
            "mission": {"range_km": 1000, "payload_kg": 500, "cruise_speed_kmh": 300},
            "constraints": {"takeoff_distance_m": 500, "stall_speed_kmh": 100},
        },
        "weights": {"mtow_kg": 3000, "empty_a": 0.9, "empty_b": -0.05},  # Initial guess
        "geometry": {
            "fuselage": {"length_m": 10.0, "diameter_m": 1.2},
            "wing": {"s_ref_m2": 20.0, "aspect_ratio": 8.0},
        },
        "systems": {
            "landing_gear": {"type": "fixed", "weight_fraction_override": 0.04},
            "avionics": {"weight_kg": 150.0, "location_x_m": 1.5},
            "extra_pod": {"weight_kg": 50.0, "location_x_m": 5.0},
            "ecs": {"type": "basic", "weight_kg": 30.0},
            "anti_ice": {"type": "tks", "weight_kg": 40.0},
            "electrical": {"weight_kg": 60.0},
        },
    }
