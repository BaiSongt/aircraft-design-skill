...
class GapAnalyzer:
    ...
    def _load_requirements(self) -> List[Requirement]:
        return [
            ...
            Requirement("2", "设计要求", "总体指标, 气动, 性能, 任务剖面", ["requirements", "mission_profile", "mtow", "range"]),
            Requirement("3", "总体方案", "布局选型, 主要参数, 三面图", ["configuration", "layout", "three_view", "geometry"]),
            Requirement("4", "气动设计", "翼型, 升阻特性, 极曲线", ["airfoil", "lift", "drag", "polar", "aerodynamics"]),
            Requirement("5", "重量重心", "重量估算, 重心包线, 转动惯量", ["weight", "cg", "balance", "inertia", "center_of_gravity"]),
            Requirement("6", "飞行性能", "起降, 爬升, 巡航, 续航", ["performance", "takeoff", "landing", "climb", "cruise", "endurance"]),
            Requirement("7", "结构设计", "载荷, 材料, 结构选型", ["structure", "load", "material", "vn_diagram"]),
            Requirement("8", "动力系统", "发动机选型, 推力, 进排气", ["propulsion", "engine", "thrust", "inlet", "nozzle"]),
            Requirement("9", "系统设备", "航电, 飞控, 环控", ["avionics", "flight_control", "environmental", "system"]),
            Requirement("10", "操稳特性", "静稳定, 动稳定, 尾翼", ["stability", "control", "static_margin", "dynamic_stability", "tail_sizing"]),
