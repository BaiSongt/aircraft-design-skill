...
def calculate_nacelle_group_weight(
    *,
    ...
    return StructuralWeightResult(
        w_struct_kg=w_nac_kg,
        details={"method": "Factor of Engine Weight", "w_engine_est_lb": w_engine_lb}
    )
...
def calculate_tail_structural_weight(
    *,
    ...
    return StructuralWeightResult(
        w_struct_kg=total,
        details={"w_ht_kg": w_ht.w_struct_kg, "w_vt_kg": w_vt.w_struct_kg}
    )
