...
class WeightBalanceAnalyzer:
    ...
    def generate_scenarios(self) -> List[LoadingScenario]:
        ...
        if w_pay == 0: w_pay = self.ac.mtow_kg - self.ac.empty_weight_kg - self.ac.fuel_weight_kg
