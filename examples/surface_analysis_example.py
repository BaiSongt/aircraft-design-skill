...
def main():
    ...
    print(f"   曲率计算完成")
    print(f"   主曲率1范围: [{np.min(curvature.principal_curvature_1):.6f}, {np.max(curvature.principal_curvature_1):.6f}]")
    print(f"   主曲率2范围: [{np.min(curvature.principal_curvature_2):.6f}, {np.max(curvature.principal_curvature_2):.6f}]")
