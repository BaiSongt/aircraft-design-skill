...
def test_fuel_system_weight():
    ...
    fuel_kg = 1000.0
    fuel_vol_m3 = 1000.0 / 804.0 # 1.2438 m3
    fuel_vol_gal = fuel_vol_m3 / 0.00378541 # 328.57 gal
    
    # Split 50/50
    fgw = fuel_vol_gal * 0.5 # 164.28
    fgf = fuel_vol_gal * 0.5 # 164.28
    
    # Weights in lbs
    # Supports: 0.009 * FGW + 0.006 * FGF
    w_support = 0.009 * fgw + 0.006 * fgf
...
def test_propulsion_system_weight():
    ...
    res = calculate_propulsion_system_weight(
        ...
        fuselage_length_m=15.0,
        has_afterburner=True,
        installation_type="fighter"
    )
