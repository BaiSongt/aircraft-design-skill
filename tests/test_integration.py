...
def test_full_integration_flow(tmp_path):
    ...
    # Setup input file
    input_data = {
        "requirements": {"range_m": 1000000.0, "payload_kg": 500.0, "cruise_mach": 0.6, "cruise_altitude_m": 8000.0},
        "initial_guess": {"mtow_kg": 5000.0},
    }
...
def test_performance_sla():
    ...
    guess = InitialGuess(mtow_kg=10000.0, wing_loading_pa=3000.0, thrust_to_weight=0.5)
