...
vsp.SetParmVal(fuse_id, 'Length', 'Design', 7.5)
vsp.SetParmVal(fuse_id, 'Diameter', 'Design', 1.2)
...
vsp.SetParmVal(wing_id, 'Sweep', 'XSec_1', 5.0)
...
vsp.SetParmVal(tail_id, 'Sweep', 'XSec_1', 5.0)
